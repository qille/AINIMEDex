...
            });
          } else {
            toast.error('Failed to switch to Galileo Testnet. Please switch manually.', {
              position: 'bottom-left',
            });
...
      const newWalletData = { address, chainId: newChainId };
      setWalletData(newWalletData);
      onWalletDataChange(newWalletData);
      toast.success(`Connected to ${address.substring(0, 6)}...${address.substring(38)}`, {
        position: 'bottom-left',
      });
    } catch (error) {
