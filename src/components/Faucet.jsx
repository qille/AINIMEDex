...
      // Check for a specific error message from the smart contract
      if (error.message.includes("You can only claim every 48 hours")) {
        toast.error(`You can only claim this faucet every 48 hours. Please try again later.`, {
